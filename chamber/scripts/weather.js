...
async function fetchWeather() {
    const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?lat=36.17187151307037&lon=-115.14330849154501&units=metric&appid=${apiKey}`);
    ...
    const forecastResponse = await fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=36.17187151307037&lon=-115.14330849154501&units=metric&appid=${apiKey}`);
